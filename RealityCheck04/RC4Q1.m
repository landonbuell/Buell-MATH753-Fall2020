...
F = @(r) [  (r(1)-A(1))^2 + (r(2)-B(1))^2 + (r(3)-C(1))^2 - (c*(t(1)-r(4)))^2;
            (r(1)-A(2))^2 + (r(2)-B(2))^2 + (r(3)-C(2))^2 - (c*(t(2)-r(4)))^2;
            (r(1)-A(3))^2 + (r(2)-B(3))^2 + (r(3)-C(3))^2 - (c*(t(3)-r(4)))^2;
...
root = MultivariateNewton(F,J,r0,100);
root
